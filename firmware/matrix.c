...
static matrix_row_t read_cols(void)
{
    ...
    return ((palReadPad(GPIOB, 1)==PAL_LOW) ? 0 : (1<<0))
     | ((palReadPad(GPIOB, 0)==PAL_HIGH) ? 0 : (1<<1))
     | ((palReadPad(GPIOA, 7)==PAL_HIGH) ? 0 : (1<<1))
     | ((palReadPad(GPIOA, 6)==PAL_HIGH) ? 0 : (1<<1))
     | ((palReadPad(GPIOA, 5)==PAL_HIGH) ? 0 : (1<<1))
     | ((palReadPad(GPIOA, 4)==PAL_HIGH) ? 0 : (1<<1))
     | ((palReadPad(GPIOA, 3)==PAL_HIGH) ? 0 : (1<<1))
